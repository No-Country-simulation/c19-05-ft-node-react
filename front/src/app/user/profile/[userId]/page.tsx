    ...
    <div className="px-6 container mx-auto pt-32 sm:pt-24 mb-20">
      ...
      <div className="shadow rounded-xl mb-6 bg-white py-6 px-8">
        ...
        <p className="text-gray-600">
          Hello! I'm Owen Paulo Vassarotto, a passionate web developer based in
          Los Angeles, United States. I specialize in creating dynamic and
          responsive web applications using modern technologies like React,
          Next.js, TailwindCSS, Node.js, Express, MongoDB, and MySQL. My journey
          in software programming has equipped me with strong technical skills
          and a deep understanding of web development.
        </p>
      </div>

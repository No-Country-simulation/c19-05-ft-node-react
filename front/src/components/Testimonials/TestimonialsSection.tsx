...
import JavierMileiPhoto from "@/assets/JavierMilei.jpg";
        ...
        <Slider {...settings}>
            ...
            <div>
                <div className="flex flex-col items-center justify-center text-center text-gray-800 my-8 px-6">
                    ...
                    <h3 className="sm:max-w-sm md:max-w-lg lg:max-w-2xl mb-6 text-lg">¡Talent Trade es una plataforma increíble! He podido intercambiar conocimientos con expertos de todo el mundo y mejorar mis habilidades en áreas que nunca imaginé.</h3>
